...
<html>
    ...
    <?php
      require('script/check_database.php');
        ...
        $sql = "SELECT `good_num`,`good_image`,`good_name`,`good_price`,`good_stat`,`good_class`,`good_class_number`,`good_class_item`,`good_way`,`good_details` FROM `good` WHERE good.good_class_number='$id' AND good.good_class_item='$name_item'	 ";
